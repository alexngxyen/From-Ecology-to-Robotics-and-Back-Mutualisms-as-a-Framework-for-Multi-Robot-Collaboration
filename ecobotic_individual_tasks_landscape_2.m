%% Ecobotics Individual Task Completion (Landscape 2 - Uniform)
%
...
% a uniform pixel distribution. The robots traverse the shortest 
...
% Print Results
fprintf('\nIndividual Tasks (Landscape 2 - Uniform)\n');
