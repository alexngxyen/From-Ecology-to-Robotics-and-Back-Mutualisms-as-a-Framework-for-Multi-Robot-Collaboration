%% Ecobotics Individual Task Completion (Landscape 1 - Very Uniform)
%
...
% with a very uniform pixel distribution. The robots traverse the shortest 
...
% Print Results
fprintf('\nIndividual Tasks (Landscape 1 - Very Uniform)\n');
