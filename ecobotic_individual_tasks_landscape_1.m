%% Ecobotics Individual Task Completion (Landscape 1 - Very High-Variability)
%
% Description: This demo is for two amphibious robots completing their
% respective tasks individually, i.e., no mutualism, in an environment 
% with a very high-variability landscape profile. 
%
...
if flag_mp4_video == 1
    ...
    video_filename = 'ecobotic_individual_tasks_very_uniform.mp4';
...
if flag_save_workspace == 1
    save('ecobotic_individual_tasks_very_uniform_logs.mat');
end
...
% Print Results
fprintf('\nIndividual Tasks (Landscape 1 - Very High-Variability)\n');
