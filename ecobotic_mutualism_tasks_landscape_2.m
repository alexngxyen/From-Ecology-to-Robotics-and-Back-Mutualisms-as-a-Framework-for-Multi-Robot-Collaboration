%% Ecobotics Mutualism Task Completion (Landscape 2 - Uniform)
%
...
% environment with a uniform pixel distribution. The robots traverse
...
% Print Results
fprintf('\nMutualism Tasks (Landscape 2 - Uniform)\n');
