%% Ecobotics Mutualism Task Completion (Landscape 2 - High-Variability)
%
...
% environment with a high-variability landscape profile. The transitions
...
%     iteration_caption = sprintf('Iteration %d', 0);
    ...
    environment = sprintf('high-variability Pixel Distribution');
...
E_r_switch = switch_cost*3;  % switching cost for rabbit [J]
...
E_t_switch = switch_cost*3;  % switching cost for turtle [J]
...
% Print Results
fprintf('\nMutualism Tasks (Landscape 2 - High-Variability)\n');
