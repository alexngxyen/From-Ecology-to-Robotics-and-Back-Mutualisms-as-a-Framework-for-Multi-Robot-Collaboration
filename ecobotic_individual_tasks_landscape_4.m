%% Ecobotics Individual Task Completion (Landscape 4 - Very Clumped)
%
...
% with a very clumped pixel distribution. The robots traverse the shortest
...
%     iteration_caption = sprintf('Iteration %d', 0);
    ...
    environment = sprintf('Clumped Pixel Distribution');
...
% Print Results
fprintf('\nIndividual Tasks (Landscape 4 - Very Clumped)\n');
