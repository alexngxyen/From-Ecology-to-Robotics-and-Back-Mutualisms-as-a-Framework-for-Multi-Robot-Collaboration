%% Ecobotics Individual Task Completion (Landscape 4 - Very Low-Variability)
%
...
% with a very low-variability landscape profile.
%
...
if flag_mp4_video == 1
    ...
    video_filename = 'ecobotic_individual_tasks_clumped.mp4';
...
%     iteration_caption = sprintf('Iteration %d', 0);
    ...
    environment = sprintf('low-variability Pixel Distribution');
...
if flag_save_workspace == 1
    save('ecobotic_individual_tasks_clumped_logs.mat')
end
...
% Print Results
fprintf('\nIndividual Tasks (Landscape 4 - Very Low-Variability)\n');
